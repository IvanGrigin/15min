...
class CombinatoricsDomain(MathDomain):
    code = "combinatorics"
    label = "Комбинаторика"
    description = "Блок задач на правило произведения в сюжетных сценах."
    ...
    def generate_bundle(
        ...
        *,
        ...
        factories = {
            "combo_outfit_pairs": templates.generate_outfit_pairs,
            "combo_route_pairs": templates.generate_route_pairs,
        }
