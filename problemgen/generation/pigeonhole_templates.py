...
def _three(t,r,s):
 ...
 text=f"В пенале есть ручки, карандаши и фломастеры. Если убрать {count_with_word_ru(removed_pens,('ручка','ручки','ручек'))}, среди любых {count_with_word_ru(first_guarantee,('предмет','предмета','предметов'))} оставшихся есть карандаш. Если убрать {count_with_word_ru(removed_pencils,('карандаш','карандаша','карандашей'))}, среди любых {count_with_word_ru(guarantee,('предмет','предмета','предметов'))} оставшихся есть ручка. После удаления всех ручек какое наибольшее количество предметов может быть в пенале при любых количествах, удовлетворяющих этим условиям?"
...
def _inventory(t,r,s):
 red=r.randint(8,25); blue=red-1; no_white=red+blue-4; answer=inventory_total(red,blue,no_white); text=f"В мешке есть белые, красные и синие карандаши. Среди любых {count_with_word_ru(red,('карандаш','карандаша','карандашей'))}, вынутых из мешка, есть хотя бы один красный карандаш; среди любых {count_with_word_ru(blue,('карандаш','карандаша','карандашей'))} — хотя бы один синий карандаш. {count_with_word_ru(no_white,('карандаш','карандаша','карандашей'))} можно вынуть без белого. Сколько карандашей может быть в мешке?";return _make(t,text,answer,{"red_guarantee_draw":red,"blue_guarantee_draw":blue,"no_white_draw":no_white},s)
def _target(t,r,s):
 other=r.randint(4,40); target=r.randint(4,40); required=r.randint(2,min(8,target)); answer=guarantee_target(other,required); text=f"В коробке {count_with_word_ru(other,('белый шарик','белых шарика','белых шариков'))} и {count_with_word_ru(target,('чёрный шарик','чёрных шарика','чёрных шариков'))}. Какое минимальное число шариков нужно достать, чтобы гарантированно получить {count_with_word_ru(required,('чёрный шарик','чёрных шарика','чёрных шариков'))}?";return _make(t,text,answer,{"other_count":other,"target_count":target,"required_target":required},s)
