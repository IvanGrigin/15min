...
- «Придумайте четыре числа с суммой 173, произведение которых кончается
  шестью нулями» (209, 227, 342, 361) и «представьте 575 в виде произведения
  нескольких чисел с суммой 37» (597) — **structured_answer**. Верных наборов
  много, перечислить их в ключе нельзя, а печатать один — значит поставить
  крестик ребёнку с другим верным ответом.
