...
- краткосрочный реестр claims по тематическим группам;
- связывает группу с веткой и владельцем, чтобы не пересекаться при замене bridge-шаблонов;
- обновляется автором группы до `done` после закрытия всех её листьев.
