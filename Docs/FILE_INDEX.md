...
- для J01–J07 хранит 122 завершённые привязки к авторским шаблонам движения и заметки о скрытых расстояниях, средней скорости и круговом движении;
...
- содержит авторские шаблоны движения J01–J07: `j01_two_stage_distance_001`, `j02_opposite_motion_delay_001`, `j03_catch_up_001`, `j04_three_movers_001`, `j05_out_and_back_001`, `j06_average_speed_001`, `j07_circular_meeting_001`;
...
- стратегии J03–J07 (`j03_catch_up`, `j04_three_movers`, `j05_out_and_back`, `j06_average_speed`, `j07_circular_meeting`) строят точные ответы для авторских motion-шаблонов; J01/J02 переиспользуют `movement_two_stage` и `opposite_motion_delay`.
