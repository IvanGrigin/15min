...
- тематическое дерево read-only корпуса `Docs/all_tasks_all_files.md`;
- группирует семейства задач по математической теме и примерной сложности;
...
- локальная HTML-страница для визуального просмотра дерева корпуса задач;
- показывает темы, уровни сложности и типичные примеры в более удобном виде;
