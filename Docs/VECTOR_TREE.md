...
## Если нужно понять, какая тематическая ветка сейчас занята

Смотреть:

- `Docs/BRANCH_ACTIVITY.md`

Там указаны владелец, границы группы, статус и прогресс. Статус
«свободна для перепроверки» означает, что авторинг завершён и допустимы только
ревью и исправления по его результатам.
